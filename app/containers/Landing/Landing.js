...
const Landing = function() {
	...
	const readings = [
		{ rfcNumber: '7', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Danny Hillis', link: '' },
		{ rfcNumber: '6', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Joel Gustafson', link: '' },
		{ rfcNumber: '5', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Travis Rich and SJ Klein', link: '' },
		{ rfcNumber: '4', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Zach Verdin', link: '' },
		{ rfcNumber: '3', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Danny Hillis', link: '' },
		{ rfcNumber: '2', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Danny Hillis, SJ Klein, and Joel Gustafson', link: '' },
		{ rfcNumber: '1', title: 'Exploring the numeric functions of reduction', date: 'Aug 3, 2020 · Danny Hillis', link: '' },
		...
		<div id="landing-page">
			...
			<section className="how">
					...
					{blocks.map((item) => {
						return (
							<div className="block">
								...
								<div className="link"><a className="button" href={item.spec}>{item.specText}</a></div>
							</div>
						);
					})}
				</div>
				<div className="registry-block">
					...
					<div className="text">A hosted service that manages collections and implements usage policies. Registries can implement query capabilities, user authentication, or other features that make the content and its creation more accessible.</div>
					<div className="text">A first Underlay registry, R1, is being developed in parallel to the protocol and specs.</div>
					<div className="link"><a className="button" href="https://r1.underlay.org">Visit R1</a></div>
					</div>
					...
					{readings.map((item) => {
						return (
							<a className="reading" href={item.link}>
								<div><b>RFC {item.rfcNumber}</b> {item.title}</div>
